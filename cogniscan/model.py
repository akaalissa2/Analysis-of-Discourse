...
# обучает модель и возвращает дополнительные данные для оценки
def train_model(X, y):
    ...
    # Возвращаем модель, скейлер, метрики, а также тестовые данные и предсказания
    return model, scaler, metrics, X_test, y_test, y_pred, y_proba
